...
from monai.transforms import ResizeWithPadOrCrop, NormalizeIntensity, EnsureChannelFirst, ToNumpy, Resize

from transforms import transform_yAware_all, transform_yAware_cutout, transform_yAware_crop
...
class MRI_dataset(Dataset):
    ...
    def __init__(self, config, data_csv, img_dict, data_type):
        ...
        self.dataset = ImageDataset(image_files=list(img_dict.values()), labels=labels,
                                    transform=basic_transform(resize_method = config.resize_method,shape=self.shape))
