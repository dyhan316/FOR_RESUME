...
def argument_setting():
    ...
    parser.add_argument("--stratify", type=str, choices=["strat", "balan", "iter_strat", "balan_iter_strat", "balan_strat"],
...
def get_info_fold(kf_split, df, target_col): #get info from fold
    ...
    * target_col : the columns in the df that I'll take statistics of 
    ...
    target_col = list(filter(lambda x: df[x].nunique()<=10, target_col))
