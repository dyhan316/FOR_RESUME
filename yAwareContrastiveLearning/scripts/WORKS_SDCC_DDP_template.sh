...
#SBATCH -p volta
#SBATCH -t 02:00:00 #volta can only do four hours for voltadebug...
#SBATCH --chdir=../
...
export MASTER_PORT=29051

##MUST BE RUN IN TERMINAL, NOT JUPYTER TERMINAL!! (permission문제인가..? 모르겠다)
...
srun python main_multilabel_DALI.py --mode pretraining --framework yaware --ckpt_dir ${save_path}/ckpt_TEST_TEST_4 --batch_size 64 --dataset2use ABCD --run_where SDCC 
