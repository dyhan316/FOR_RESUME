...
#on slurm sbatch
#python main_multilabel_DALI.py --mode pretraining --framework yaware --ckpt_dir $save_path/ckpt_TEST --batch_size 8 --dataset2use test --run_where SDCC --wandb_name test --lr 1e-3 --sigma 0.05 

##interactively  (DP instead of DDP)
#python main_multilabel_DALI.py --mode pretraining --framework yaware --ckpt_dir $save_path/ckpt_TEST --batch_size 8 --dataset2use test --run_where SDCC --wandb_name test --lr 1e-3 --sigma 0.05 --DP_DEBUG True #set 
