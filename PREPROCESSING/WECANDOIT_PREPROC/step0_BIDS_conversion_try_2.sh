...
extracted_inputs_save_dir='/storage/bigdata/WECANDOIT/2.extracted_inputs_test_jan_4' #output directory
...
output_dir='/storage/bigdata/WECANDOIT/3.BIDS_raw_test_jan_4' #output directory
