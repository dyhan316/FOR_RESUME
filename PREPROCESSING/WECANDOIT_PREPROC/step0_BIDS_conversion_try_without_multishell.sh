...
extracted_inputs_save_dir='/storage/bigdata/WECANDOIT/2.extracted_inputs_real_jan' #output directory
...
output_dir='/storage/bigdata/WECANDOIT/3.BIDS_raw_real_jan_without_mult' #output directory
...
######################
   ...
   # mrconvert -nthreads 20 ${sub}/*DTI_MB3_LR_B3000 ${sub_out}/dwi/sub-${sub_idx}_acq-mb3_singleshell_b3000_dir-LR_dwi.nii.gz -json_export ${sub_out}/dwi/sub-${sub_idx}_acq-mb3_singleshell_b3000_dir-LR_dwi.json -export_grad_fsl ${sub_out}/dwi/sub-${sub_idx}_acq-mb3_singleshell_b3000_dir-LR_dwi.bvecs ${sub_out}/dwi/sub-${sub_idx}_acq-mb3_singleshell_b3000_dir-LR_dwi.bval
    #mrcat -nthreads 20 ${sub}/*DTI_MB3_LR_B*/ ${sub}/multishell/
    #dcm2niix  -o ${sub_out}/tmp/sub-${sub_idx}_acq-mb3multishell_dir-LR_dwi.nii.gz -json_export ${sub_out}/tmp/multishell.json -export_grad_fsl ${sub_out}/tmp/bvecs ${sub_out}/tmp/bvals -z y ${sub}/multishell
...
###################### dwi ######################
    ...
    elif [[ "${files}" == *"_LR_B1000_"* ]] && [[ "${files}" == *".json"* ]]
    then
        mv $files "${sub_out}/dwi/sub-${sub_idx}_acq-mb3-b1000_dir-LR_dwi.json"

    elif [[ "${files}" == *"_LR_B1000_"* ]] && [[ "${files}" == *".nii.gz"* ]]
    then
        mv $files "${sub_out}/dwi/sub-${sub_idx}_acq-mb3-b1000_dir-LR_dwi.nii.gz"

    elif [[ "${files}" == *"_LR_B1000_"* ]] && [[ "${files}" == *".bval"* ]]
    then
        mv $files "${sub_out}/dwi/sub-${sub_idx}_acq-mb3-b1000_dir-LR_dwi.bval"

    elif [[ "${files}" == *"_LR_B1000_"* ]] && [[ "${files}" == *".bvec"* ]]
    then
        mv $files "${sub_out}/dwi/sub-${sub_idx}_acq-mb3-b1000_dir-LR_dwi.bvec"
        
    ##################################
        
    elif [[ "${files}" == *"_LR_B2000_"* ]] && [[ "${files}" == *".json"* ]]
    then
        mv $files "${sub_out}/dwi/sub-${sub_idx}_acq-mb3-b2000_dir-LR_dwi.json"

    elif [[ "${files}" == *"_LR_B2000_"* ]] && [[ "${files}" == *".nii.gz"* ]]
    then
        mv $files "${sub_out}/dwi/sub-${sub_idx}_acq-mb3-b2000_dir-LR_dwi.nii.gz"

    elif [[ "${files}" == *"_LR_B2000_"* ]] && [[ "${files}" == *".bval"* ]]
    then
        mv $files "${sub_out}/dwi/sub-${sub_idx}_acq-mb3-b2000_dir-LR_dwi.bval"

    elif [[ "${files}" == *"_LR_B2000_"* ]] && [[ "${files}" == *".bvec"* ]]
    then
        mv $files "${sub_out}/dwi/sub-${sub_idx}_acq-mb3-b2000_dir-LR_dwi.bvec"
        
        
    ########################################
    
    elif [[ "${files}" == *"_LR_B3000_"* ]] && [[ "${files}" == *".json"* ]]
    then
        mv $files "${sub_out}/dwi/sub-${sub_idx}_acq-mb3-b3000_dir-LR_dwi.json"

    elif [[ "${files}" == *"_LR_B3000_"* ]] && [[ "${files}" == *".nii.gz"* ]]
    then
        mv $files "${sub_out}/dwi/sub-${sub_idx}_acq-mb3-b3000_dir-LR_dwi.nii.gz"

    elif [[ "${files}" == *"_LR_B3000_"* ]] && [[ "${files}" == *".bval"* ]]
    then
        mv $files "${sub_out}/dwi/sub-${sub_idx}_acq-mb3-b3000_dir-LR_dwi.bval"

    elif [[ "${files}" == *"_LR_B3000_"* ]] && [[ "${files}" == *".bvec"* ]]
    then
        mv $files "${sub_out}/dwi/sub-${sub_idx}_acq-mb3-b3000_dir-LR_dwi.bvec"
